...
import {
  getTotalBadgeRanking,
  getFolloweeTotalBadgeRanking,
  getTotalPointRanking,
  getFolloweeTotalPointRanking,
  getMonthlyPointRanking,
  getFolloweeMonthlyPointRanking,
  getTotalMealRanking,
  getWeeklyMealRanking,
} from "./../api";
...
const Home: React.FC = () => {
  ...
  const allRanking = [
    ...
    "Weekly Meal Ranking",
    "Total Badge Ranking",
    "Followee Total Badge Ranking",
    "Total Point Ranking",
    "Followee Total Point Ranking",
    "Monthly Point Ranking",
    "Followee Monthly Point Ranking",
  ];
  useLoginRedirect();
    ...
    <Container component="main" maxWidth="xs">
      <div className={classes.main}>
        <div className="back_rank">
          <h3 className="animate__animated animate__jello" id="h3_back">
            Ranking
          </h3>
        </div>
        ...
        <div>
          <FormControl className={classes.formControl}>
            ...
            <Select value={rankingType} onChange={(e) => setRankingType(e.target.value as string)}>
        ...
        <div hidden={rankingType !== "Total Meal Ranking"}>
          <Paper className={classes.paper}>
            <Typography component="h4" variant="h6">
              <div id="service">Total Dish Ranking</div>
            </Typography>
            {mealList[0] ? (
              <MealLists mealLists={mealList} />
            ) : (
        ...
        <div hidden={rankingType !== "Weekly Meal Ranking"}>
          <Paper className={classes.paper}>
            <Typography component="h4" variant="h6">
              <div id="service">Weekly Dish Ranking</div>
            </Typography>
            {weeklyMealList[0] ? (
              <MealLists mealLists={mealList} />
            ) : (
        ...
        <div hidden={rankingType !== "Total Badge Ranking"}>
          <Paper className={classes.paper}>
            <Typography component="h4" variant="h6">
              <div id="service">Total Badge Ranking</div>
            </Typography>
            {badgeList[0] ? (
              <BadgeRankerList badgeList={badgeList} />
            ) : (
              <p style={{ textAlign: "center" }}>
                <MDSpinner size={56} />
              </p>
        ...
        <div hidden={rankingType !== "Followee Total Badge Ranking"}>
          <Paper className={classes.paper}>
            <Typography component="h4" variant="h6">
              <div id="service">Followee Total Badge Ranking</div>
            </Typography>
            {followeebadgeList[0] ? (
              <BadgeRankerList badgeList={followeebadgeList} />
            ) : (
              <p style={{ textAlign: "center" }}>
                <MDSpinner size={56} />
              </p>
        ...
        <div hidden={rankingType !== "Total Point Ranking"}>
          <Paper className={classes.paper}>
            <Typography component="h4" variant="h6">
              <div id="service">Total Point Ranking</div>
            </Typography>
            {pointList[0] ? (
              <BadgeRankerList badgeList={pointList} />
            ) : (
              <p style={{ textAlign: "center" }}>
                <MDSpinner size={56} />
              </p>
        ...
        <div hidden={rankingType !== "Followee Total Point Ranking"}>
          <Paper className={classes.paper}>
            <Typography component="h4" variant="h6">
              <div id="service">Followee Total Point Ranking</div>
            </Typography>
            {followeepointList[0] ? (
              <BadgeRankerList badgeList={followeepointList} />
            ) : (
              <p style={{ textAlign: "center" }}>
                <MDSpinner size={56} />
              </p>
        ...
        <div hidden={rankingType !== "Monthly Point Ranking"}>
          <Paper className={classes.paper}>
            <Typography component="h4" variant="h6">
              <div id="service">Monthly Point Ranking</div>
            </Typography>
            {monthlypointList[0] ? (
              <BadgeRankerList badgeList={monthlypointList} />
            ) : (
              <p style={{ textAlign: "center" }}>
                <MDSpinner size={56} />
              </p>
        ...
        <div hidden={rankingType !== "Followee Monthly Point Ranking"}>
          <Paper className={classes.paper}>
            <Typography component="h4" variant="h6">
              <div id="service">Followee Monthly Point Ranking</div>
            </Typography>
            {followeemonthlypointList[0] ? (
              <BadgeRankerList badgeList={followeemonthlypointList} />
            ) : (
              <p style={{ textAlign: "center" }}>
                <MDSpinner size={56} />
              </p>
