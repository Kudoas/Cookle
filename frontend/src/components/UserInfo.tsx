  ...
  return (
    <div className={classes.main}>
      <Link className={classes.link} href={userId ? `/${userId}/followee` : "/followee"}>
        <Badge className={classes.badge} badgeContent={followee} showZero color="secondary">
          フォロー
        </Badge>
      </Link>
      <Link className={classes.link} href={userId ? `/${userId}/follower` : "/follower"}>
        <Badge className={classes.badge} badgeContent={followers} showZero color="secondary">
          フォロワー
        </Badge>
      </Link>
